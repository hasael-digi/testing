  ...
  return (
    ...
    >
      ...
      <div className='w-full relative mt-5 flex flex-col justify-center md:ml-10 gap-10'>
        <h1 className='text-[32px] font-semibold shadow-sm shadow-black p-2 rounded-2xl border-b w-[32%] md:w-[29%]'>ABOUT ME</h1>
        <p className='text-justify text-slate-300'>
          ...
          advancements. Although I don't have any official projects yet, I have created a personal website based on tutorials I found on YouTube. I am
          always enthusiastic about creating creative solutions and providing optimal user experiences.
        </p>
